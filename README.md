...
#### 从源码安装
```bash
git clone https://github.com/yourusername/python-special-heatmap.git
cd python-special-heatmap/python_reproduction
pip install .
```

### 2 基础使用 (Basic use)

#### 2.1 绘制正数热图 (Draw positive heat map)
...
### 4 设置为上三角或下三角 (Triangular Layouts)
